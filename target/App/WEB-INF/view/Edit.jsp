...
<div class="register-form " >
  ...
  <div class="form">
   <h3>Edit Product </h3>
    ...
    <form:form class="login-form"  method="POST" action="update?${_csrf.parameterName}=${_csrf.token}"  modelAttribute="product" enctype="multipart/form-data">
      ...
      <form:input path="subctg" value="${productObject.subctg}"/>
       <form:input path="pqty" value="${productObject.pqty}"/>
        <form:input path="price" value="${productObject.price}"/>
         ...
         Add Image: <input type="file"  path="file1" name="file1" id="file1"/>
